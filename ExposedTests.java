...
public class ExposedTests {
    ...
    @DisplayName("extra")
    public void extra(){
        ERPriorityQueue testPatients=new ERPriorityQueue();

        testPatients.add("Hannah",5);
        testPatients.add("Ebony",10);
        testPatients.add("Ricardo3",60);
        testPatients.add("Ricardo",60);
        testPatients.add("Ahmad",15);
        testPatients.add("Zil",30);
        testPatients.add("Gilbert",100);

        testPatients.add("Ricardo1",60);
        //you should get {Ricardo3=6, Ricardo1=8, Ricardo=4, Hannah=1, Ebony=2, Gilbert=7, Zil=3, Ahmad=5}
